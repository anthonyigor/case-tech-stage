    ...
    <div className="fixed inset-0 z-50 grid place-items-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-2xl bg-slate-950/80 ring-1 ring-white/10 backdrop-blur-xl p-4">
        ...
        <div className="mt-4 space-y-3">
          ...
          {data && (
            <div>
                <label className="text-sm text-slate-300">Pessoas</label>
                ...
                {selectedIds.length > 0 ? (
                    ...
                    {selectedIds.map((id) => {
                        ...
                        >
                            {person?.name ?? id} <span className="opacity-60">✕</span>
                        </button>
                        );
                    })}
                    </div>
                ...
                {data.map((p: Person) => {
                    ...
                    >
                        ...
                        <div
                            ...
                            selected ? "bg-sky-500/15 text-sky-100 ring-sky-500/30" : "bg-white/5 text-slate-300 ring-white/10",
                            ].join(" ")}
                        >
